...
" <配置代码tab风格>
" -----------------------------------------------------------------------------
let g:is_linux_style = 1
let g:is_rtt_style =  0
...
" Bundle 'a.vim' "用于切换C/C++头文件
" Bundle 'Align'
" Bundle 'bufexplorer.zip' "快速轻松的在缓存中切换
" Bundle 'ctrlpvim/ctrlp.vim'
" Bundle 'mattn/emmet-vim'
" Bundle 'vim-javacompleteex'
" Bundle 'msanders/snipmate.vim'
" Bundle 'tpope/vim-surround'
" Bundle 'scrooloose/syntastic' "用于保存文件时查检语法
" Bundle 'ZoomWin'

" Bundle 'jiangmiao/auto-pairs' "用于括号与引号自动补全
" Bundle 'ccvext.vim' "用于对指定文件自动生成,待定
" Bundle 'cSyntaxAfter' "高亮括号与运算符等
" Bundle 'Yggdroot/indentLine' "用于显示对齐线
" Bundle 'Mark--Karkat' "给不同的单词高亮，表明不同的变量时很有用 :h mark.txt
" Bundle 'Shougo/neocomplcache.vim' "关键字补全、文件路径补全、tag补全等等，各种，非常好用，速度超快
" Bundle 'scrooloose/nerdcommenter' " 用于C/C++代码注释
" Bundle 'scrooloose/nerdtree' "有目录村结构的文件浏览插件
" Bundle 'OmniCppComplete' "用于C/C++代码补全
" Bundle 'Lokaltog/vim-powerline' "状态栏插件，更好的状态栏效果
" Bundle 'repeat.vim' "主要用"."命令来重复上次插件使用的命令
" " Bundle 'wesleyche/SrcExpl' "增强源代码浏览，其功能就像Windows中的"Source Insight"
" Bundle 'std_c.zip' "用于增强C语法高亮
" Bundle 'majutsushi/tagbar' "相对 TagList 能更好的支持面向对象
" Bundle 'taglist.vim' "高效地浏览源码, 其功能就像vc中的workpace
...
if (is_linux_style)
    ...
    set tabstop=8                                     "设置Tab键的宽度，可以更改，如：宽度为8
...
"    colorscheme solarized8_dark_low             "终端配色方案
...
" -----------------------------------------------------------------------------
" F9 一键保存、编译、连接存并运行
"nmap <a-F9> :call Run()<CR>
"imap <a-F9> <ESC>:call Run()<CR>
...
" itself are using buffers. And you need add their buffer names into
" below list
...
" autocmd for
" // BufReadPre might have conflicts with Source Explorer. e.g. YCM,
" Syntastic etc.
...
"    nmap <C-\>d :cs find d <C-R>=expand("<cword>")<CR><CR>
    ...
    nmap <silent> <F5> :cs find c <C-R>=expand("<cword>")<CR><CR>
...
Plug 'liuchengxu/space-vim-theme' "Vim 主题 colorscheme space_vim_theme
Plug 'mhinz/vim-startify' "起始页插件
Plug 'kien/ctrlp.vim' " 模糊搜索
Plug 'tacahiroy/ctrlp-funky' "可以模糊搜索文件内容的方法名
Plug 'vim-airline/vim-airline' "vim的底部状态增强/美化插件
Plug 'vim-airline/vim-airline-themes'
"Plug 'jonathanfilip/vim-lucius'
Plug 'lfv89/vim-interestingwords'
Plug 'airblade/vim-gitgutter' "git 状态插件
Plug 'jiangmiao/auto-pairs' "用于括号与引号自动补全
Plug 'Yggdroot/indentLine' "用于显示对齐线
Plug 'Shougo/neocomplcache.vim' "关键字补全、文件路径补全、tag补全等等，各种，非常好用，速度超快
Plug 'scrooloose/nerdcommenter' " 用于C/C++代码注释
Plug 'scrooloose/nerdtree' "有目录村结构的文件浏览插件
"Plug 'Lokaltog/vim-powerline' "状态栏插件，更好的状态栏效果
Plug 'wesleyche/SrcExpl' "增强源代码浏览，其功能就像Windows中的Source Insight
Plug 'majutsushi/tagbar' "相对 TagList 能更好的支持面向对象
Plug 'vim-scripts/cSyntaxAfter' "高亮括号与运算符等
Plug 'vim-scripts/taglist.vim' "高效地浏览源码, 其功能就像vc中的workpace
Plug 'vim-scripts/OmniCppComplete' "C/C++代码补全
"Plug 'brooth/far.vim' "批量搜索替代
"Plug 'machakann/vim-highlightedyank' "高亮显示复制
call plug#end()
" Plug 'taglist.vim' "高效地浏览源码, 其功能就像vc中的workpace
" Plug 'TxtBrowser' "用于文本文件生成标签与与语法高亮
" Plug 'std_c.zip' "用于增强C语法高亮
" Plug 'repeat.vim' "主要用.命令来重复上次插件使用的命令
" Plug 'OmniCppComplete' "用于C/C++代码补全
" Plug 'ccvext.vim' "用于对指定文件自动生成,待定 
" Plug 'Mark--Karkat' "给不同的单词高亮，表明不同的变量时很有用 :h mark.txt
set background=dark
